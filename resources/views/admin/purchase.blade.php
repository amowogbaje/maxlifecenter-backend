...
<div class="p-4 lg:p-[32px] space-y-6 lg:space-y-8">
    ...
    <div class="space-y-4">
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <h2 class="text-xl lg:text-2xl font-bold text-foreground">Purchase</h2>
            <div class="flex items-center gap-4 w-full lg:w-auto">
                <form method="GET" action="{{ route('admin.purchases')}}">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-2 sm:gap-4 lg:gap-6">
                                ...
                                <div class="flex flex-col min-w-0">
                                    ...
                                    <span class="text-[10px] sm:text-xs lg:text-base text-text-dark truncate" title="{{ $purchase->date_completed  }}">{{ \Carbon\Carbon::parse($purchase->date_created)->format('M d, Y H:i a') }}</span>
                                </div>
