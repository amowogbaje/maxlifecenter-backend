...
<style>
    /* Match your theme's focus color */
    trix-editor:focus {
    ...
    /* Hide the default attachment button if you don't want image uploads yet */
    ...
    <div class="w-full max-w-[850px] bg-white rounded-[24px] p-8 md:p-12 flex flex-col gap-12">
        ...
        <form action="{{ route('admin.updates.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-12">
            ...
            <div class="flex flex-col gap-[10px]">
                ...
                <trix-editor input="body" placeholder="Write your update here..." class="bg-white text-sm text-[#7D8592]"></trix-editor>
