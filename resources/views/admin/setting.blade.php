                                    ...
                                    <div :class="{ 'text-black': activeTab === 'account', 'text-text-secondary': activeTab !== 'account' }">
                                        <div class="w-6 h-6 flex items-center justify-center">
                                            <svg width="18" height="20" viewBox="0 0 18 20" fill="currentColor">
                                                <path d="M9 10C11.7614 10 14 7.76142 14 5C14 2.23858 11.7614 0 9 0C6.23858 0 4 2.23858 4 5C4 7.76142 6.23858 10 9 10ZM9 12C4.02944 12 0 16.0294 0 21H18C18 16.0294 13.9706 12 9 12Z" /></svg>
                                        </div>
                                    </div>
                                    ...
                                    <div :class="{ 'text-black': activeTab === 'confidentiality', 'text-text-secondary': activeTab !== 'confidentiality' }">
                                        <div class="w-6 h-6 flex items-center justify-center">
                                            <svg width="20" height="21" viewBox="0 0 20 21" fill="currentColor">
                                                <path d="M16 8V6C16 2.68629 13.3137 0 10 0C6.68629 0 4 2.68629 4 6V8C1.79086 8 0 9.79086 0 12V17C0 19.2091 1.79086 21 4 21H16C18.2091 21 20 19.2091 20 17V12C20 9.79086 18.2091 8 16 8ZM6 6C6 3.79086 7.79086 2 10 2C12.2091 2 14 3.79086 14 6V8H6V6Z" /></svg>
                                        </div>
                                    </div>
                                    ...
                                    <div :class="{ 'text-black': activeTab === 'safety', 'text-text-secondary': activeTab !== 'safety' }">
                                        <div class="w-6 h-6 flex items-center justify-center">
                                            <svg width="22" height="21" viewBox="0 0 22 21" fill="currentColor">
                                                <path d="M11 0L21 4V12C21 18.075 16.425 20.19 11 21C5.575 20.19 1 18.075 1 12V4L11 0ZM11 2.236L3 5.236V12C3 16.575 6.575 18.19 11 18.905C15.425 18.19 19 16.575 19 12V5.236L11 2.236Z" /></svg>
                                        </div>
                                    </div>
            ...
            <div class="lg:hidden bg-white border-b border-gray-200 px-4 py-2 sticky top-[57px] z-10">
                <div class="flex gap-2 overflow-x-auto mobile-nav">
                    <template x-for="[tabId, title] in Object.entries(tabTitles)" :key="tabId">
                        <button @click="activeTab = tabId" :class="{
