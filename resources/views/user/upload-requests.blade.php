...
<main class="p-4 lg:p-8">
    ...
    <div class="mb-6 lg:mb-8 overflow-x-auto">
        ...
        <div class="bg-blue-100 rounded-3xl p-0 inline-flex min-w-max">
            <a href="{{ route('user.uploads') }}" class="text-dark hover:bg-dashboard-white/50 px-4 lg:px-8 py-2 lg:py-3 rounded-2xl font-bold text-sm lg:text-base transition-all whitespace-nowrap">
                Uploads
            </a>
            <a href="{{ route('user.upload-requests') }}" class="bg-yellow-400 text-dashboard-white px-4 lg:px-8 py-2 lg:py-3 rounded-2xl font-bold text-sm lg:text-base transition-all whitespace-nowrap">
                User Upload Request
            </a>
