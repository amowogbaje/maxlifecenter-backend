                ...
                <div class="flex flex-col sm:flex-row items-start gap-6 mb-6 lg:mb-0">
                    ...
                    <div class="bg-gray-100 rounded-[20px] px-6 py-4 flex items-center gap-8">
                        ...
                        <div class="flex items-center gap-3">
                            <img src="{{asset('images/icons/money.png')}}" 
                ...
                <div class="grid gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="bio" rows="4"
                            class="w-full p-4 rounded-[14px] border border-gray-300 text-gray-700 text-sm shadow-sm resize-none focus:outline-none">{{ Auth::user()->bio ?? '' }}</textarea>
                    </div>
