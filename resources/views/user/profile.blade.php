                ...
                <div class="flex flex-col sm:flex-row items-start gap-6 mb-6 lg:mb-0">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="w-[50px] h-[50px] rounded-full border-2 border-white overflow-hidden bg-gray-200">
                            <img src="{{ asset('images/profile.jpg') }}" alt="Kemi Wale" class="w-full h-full object-cover" />
                        </div>
                        <div>
                            <h2 class="text-gray-800 font-bold text-base">Kemi Wale</h2>
                            <p class="text-gray-500 text-sm">kemiwale@gmail.com</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-100 rounded-[20px] px-6 py-4 flex items-center gap-8">
                        ...
                        <div class="flex items-center gap-3">
                            <img src="https://api.builder.io/api/v1/image/assets/TEMP/7389327a8088ce0d8fa92cbba294eb87ed31e921?width=72" alt="Money icon" class="w-9 h-9" />
                            <div>
                    ...
                    <div class=" px-6 py-4 flex items-center gap-8">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="w-16 h-16 bg-green-400/20 rounded-full flex items-center justify-center mb-4">
                                ...
                                <img src="{{ asset('images/eleniyan.png')}}" alt="Money icon" class="w-10 h-10" />
                            </div>
                            <div>
                                <p class="text-gray-500 text-sm font-normal">Current Tier</p>
                                <p class="text-gray-800 font-bold text-base">Eleniyan</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="grid gap-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" value="Cadabra" class="w-full h-12 pl-12 pr-4 rounded-[14px] border border-gray-300 bg-white text-gray-700 text-sm shadow-sm focus:outline-none focus:border-blue-500" />
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="tel" value="+1 675 346 23-10" class="w-full h-12 px-4 rounded-[14px] border border-gray-300 bg-white text-gray-700 text-sm shadow-sm focus:outline-none focus:border-blue-500" />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="text" value="NYC, New York, USA" class="w-full h-12 pl-4 pr-12 rounded-[14px] border border-gray-300 bg-white text-gray-700 text-sm shadow-sm focus:outline-none focus:border-blue-500" />
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="text" value="May 19, 1996" class="w-full h-12 pl-4 pr-12 rounded-[14px] border border-gray-300 bg-white text-gray-700 text-sm shadow-sm focus:outline-none focus:border-blue-500" />
                            <div class="absolute right-4 top-1/2 transform -translate-y-1/2">
                                <!-- Calendar icon -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-gray-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="space-y-2">
                    ...
                    <textarea placeholder="Add some description of the event" rows="4" class="w-full p-4 rounded-[14px] border border-gray-300 bg-white text-gray-700 text-sm placeholder-gray-500 shadow-sm resize-none focus:outline-none focus:border-blue-500"></textarea>
                </div>
            </div>
        </div>
    </div>
