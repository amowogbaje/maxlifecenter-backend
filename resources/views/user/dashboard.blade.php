...
<div class="mb-[32px] px-6">
    <h1 class="text-[#1D1F24] text-2xl font-bold font-nunito mb-[8px]">Hi, {{auth('web')->user()->full_name}}</h1>
    ...
    <div class="bg-white rounded-2xl p-6 flex-1 max-w-full">
        ...
        <div class="space-y-5">
            ...
            <div class="bg-white rounded-xl shadow p-4 flex items-center">
                ...
                <a href="{{ route('updates.show', $update) }}" class="flex items-center flex-shrink-0 justify-center gap-x-1">
